...
OpenAI Codex, based on GPT-5, assisted English-language drafting, editorial
restructuring, Python code scaffolding and test generation. An image-generation
model produced the repository logo, which is not scientific evidence. The
author reviewed every modified manuscript section and source file, executed the
tests and controlled measurements, and checked bibliographic titles and
destination URLs against publisher, proceedings or preprint pages. Generative
AI was not treated as an author or annotator and did not supply human labels,
model responses or unexecuted empirical measurements.
