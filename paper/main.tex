...
pdftitle={Situation engineering: separating evidence applicability from availability in AI systems},
...
%% -------------------------------------------------------------
%% The audited E5 pilot is included below. Its frozen manifest, raw responses,
%% integrity audit and generated tables are shipped with this submission.
%% Set false only when intentionally building a manuscript version without E5.
\newif\ifEFiveready
\EFivereadytrue
%% =============================================================
...
and labels simulated-persona runs as synthetic rather than human evidence.
...
%% (builds supplementary.pdf; Supplementary Notes 1–13 and their tables).
