...
%%     code/audit_e5.py); flip \EFivereadytrue and report the within-model
...
%%        tests" -- until \EFivereadytrue, phrase E5 as a pre-specified/pending
...
%%
%% 026_results_e5.tex  (enabled by \EFivereadytrue)
