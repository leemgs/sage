...
The present paper makes three contributions. First, it defines situation
...
causally separable. The decisive next test is pre-specified rather than blurred
with this control study: the same model, evidence and computation budget, with
and without an explicit situation layer, on independently authored natural
text. This claim boundary distinguishes what we demonstrate from the
language-model generalization hypothesis that remains to be tested.
