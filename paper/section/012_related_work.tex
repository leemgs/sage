...
\begin{tabularx}{\linewidth}{@{}p{2.3cm}*{7}{>{\centering\arraybackslash}X}@{}}
\toprule
Area & Explicit state & Time & Observer & Worlds & Uncertainty & Answer/action gate & Provenance \\
\midrule
Situation/event calculus & $\checkmark$ & $\checkmark$ & limited & partial & usually no & action-centred & limited \\
