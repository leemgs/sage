...
E5: multi-model intervention & Audited single-family (Gemini) pilot, $n=210$, three prompt conditions & Explicit situation prompting does not significantly beat a matched structured prompt (paired $95\%$ CIs include zero); multi-family, natural-text confirmation remains open \\
