...
E5: multi-model intervention & Audited single-family (Gemini) pilot, $n=35$, three prompt conditions & Explicit situation prompting does not yet beat a matched structured prompt ($\Delta\le0$); multi-family, natural-text confirmation remains open \\
