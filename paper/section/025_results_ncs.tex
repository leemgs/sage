...
The results follow the contribution logic established above: interface
executability (RQ1), mechanism localization under controlled interventions
(RQ2), and bounded transfer to model prompting (RQ3). This ordering avoids
treating deterministic software checks and sampled model behaviour as the same
kind of evidence.
...
category (Fig.~\ref{fig:ablation}). This intervention--failure alignment is the
main mechanistic contribution of the controlled study. Within the generated
system, it shows that the implementation does not
...
executed and independently ablated under oracle structured states. The audited
