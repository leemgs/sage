...
E5: multi-model intervention & Audited single-family (Gemini) pilot, $n=210$, situation/structured/RAG conditions & Explicit situation prompting never significantly beats structured (and is significantly worse on one model) and trails a retrieval baseline overall, but wins on temporal and observer categories; multi-family, natural-text confirmation remains open \\
