...
The corresponding maturity levels are SE0, implicit model-only reasoning; SE1,
isolated state tags; SE2, provenance-linked state and update rules; SE3,
competing hypotheses with retrieve/clarify/abstain policies; and SE4, learned
multimodal sensing, multi-agent belief tracking, shift monitoring and independent
audit. The current reference implementation is SE3 only for its seven supplied
oracle variables. It is not SE4 and should not be presented as such.
