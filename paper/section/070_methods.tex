...
\end{equation}
This decomposition supports stage-specific evaluation. The current controlled
experiment supplies $S$ directly and evaluates $f_{update}$, $\pi$ and the
deterministic answer renderer. It does not evaluate $f_{sense}$ on unrestricted
language.
