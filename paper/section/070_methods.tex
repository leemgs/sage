...
refuses to create placeholder outputs when credentials are absent. Incomplete
Gemini pilot calls are archived to validate the execution path but excluded
because quota exhaustion produced unequal category coverage and no balanced
model-family comparison. The script is an executable protocol, not a completed
