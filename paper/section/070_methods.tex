...
The following larger confirmatory study remains pre-specified rather than
completed:

A confirmatory study is pre-specified to compare the following matched conditions:
