...
archives a 12-item SituatedQA temporal check and a top-3 lexical-retrieval
baseline. The integrity gate joins responses to the frozen item set and refuses
...
a verification-agent baseline under matched budgets.
