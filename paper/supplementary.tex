...
Run \texttt{python code/run\_experiments.py --n-per-category 600 --data data --out results}. The command regenerates the dataset and all CSV results deterministically.
...
\section*{Supplementary Note 10: Interfaces among engineering disciplines}
\begin{table}[h]
\centering
...
\section*{Supplementary Note 11: Engineering anti-patterns}
...
\section*{Supplementary Note 12: Minimum cross-layer reporting standard}
